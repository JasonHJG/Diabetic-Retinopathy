...
#import sklearn.metrics.confusion_matrix as confusion
#import matplotlib.pyplot as plt
...
dataset_dir = '/mnt/dfs/jason/my_DR/DR/group_data/'
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        def seg(sess, prdictions, labels):
            prediction, label = sess.run([predictions, labels])
        ...
        with sv.managed_session() as sess:
            for step in xrange(num_steps_per_epoch * num_epochs):
                ...
                pred,true = seg(sess,predictions, labels)
                ...
                if step % 2 == 0:
                    ...
                    #draw_confusion(sess, prdictions=predictions, labels=labels)
            ...
            # matrix = confusion_matrix(np.array(true), np.array(pred))
            #print matrix
            ...
            for i in range(10):
               ...
               # plt.title(text)
                ...
                #plt.show()
            """
            matrix = confusion_matrix(np.array(true_total), np.array(pred_total))
            print matrix          
